...
Run `supabase/FITNESS_ENGINE_COMPLETE.sql` once against the active Supabase project to add the fitness-specific tables, RLS, seeded exercises/achievements, readiness and workout-completion RPCs. Do not rerun the older calendar migration solely for these fitness changes.
