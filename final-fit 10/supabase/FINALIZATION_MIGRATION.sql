-- Fit Together historical migration -- DO NOT RUN FOR DEPLOYMENT.
-- The authoritative production schema is supabase/FINAL_MIGRATION.sql.
-- This file is retained only for historical/reference purposes.
...
revoke all on public.fitness_profiles,public.training_plans,public.plan_workouts,public.plan_exercises,public.workouts,public.workout_exercises,public.workout_sets,public.personal_records,public.recovery_logs,public.training_load_daily,public.achievements,public.user_achievements,public.exercises from public,anon;
grant select,insert,update,delete on public.fitness_profiles,public.training_plans,public.plan_workouts,public.plan_exercises,public.workouts,public.workout_exercises,public.workout_sets,public.personal_records,public.recovery_logs,public.training_load_daily,public.user_achievements to authenticated;
grant select on public.exercises,public.achievements to authenticated;
grant all on public.fitness_profiles,public.training_plans,public.plan_workouts,public.plan_exercises,public.workouts,public.workout_exercises,public.workout_sets,public.personal_records,public.recovery_logs,public.training_load_daily,public.achievements,public.user_achievements,public.exercises to service_role;
